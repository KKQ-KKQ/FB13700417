//
//  TestAUMacExtensionDSPKernel.hpp
//  TestAUMacExtension
//
...
#import "TestAUMacExtension-Swift.h"
#import "TestAUMacExtensionParameterAddresses.h"

/*
 TestAUMacExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class TestAUMacExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in TestAUMacExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case TestAUMacExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<TestAUMacExtensionDSPKernel *>(context);

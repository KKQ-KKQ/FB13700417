//
//  TestAUMacExtensionAUProcessHelper.hpp
//  TestAUMacExtension
//
...
#include <vector>
#include "TestAUMacExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(TestAUMacExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    TestAUMacExtensionDSPKernel& mKernel;

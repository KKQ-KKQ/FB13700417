...
private let log = Logger(subsystem: "jp.kiraqtech.TestAUMacExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<TestAUMacExtensionMainView>?
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try TestAUMacExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? TestAUMacExtensionAudioUnit else {
            log.error("Unable to create TestAUMacExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(TestAUMacExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = TestAUMacExtensionMainView(parameterTree: observableParameterTree)
